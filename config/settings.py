...
SECRET_KEY = "django-insecure-9(3+i$o&81#4rnac8y#wmr#ss=g=!xu$45d%fwob5i5ki3^+9v"
...
AUTH_USER_MODEL = 'NicaGrow.Usuario'
...
SIMPLE_JWT = {
    ...
    'USER_ID_FIELD': 'Id',                  # Usaremos un campo personalizado del modelo Cliente
